...
<template>
  ...
  <div v-if="hasError" class="alert alert-success alert-dismissible fade show" role="alert">
  ...
  <form @submit.prevent="sendLead" novalidate class="form mx-auto">
    ...
    <div class="flex" novalidate>
      <label for="name" class="form-label">
        <input class="input form-control" id="name" v-model="name" aria-describedby="emailHelp" type="text" required="">
        <span>Name</span>
      </label>
    ...
    <label for="email" class="form-label">
      <input class="input form-control" id="email" v-model="email" type="email" aria-describedby="emailHelp"
    ...
    <div class="mb-3 form-check">
      ...
      <label class="form-check-label text-white" for="newsletters">Subscribe to the NewsLetters</label>
    </div>
